...
@EqualsAndHashCode
public final class CodeEnumIntUtils {

    private CodeEnumIntUtils() {
    }
    ...
    public static <T extends CodeEnum> T fromCode(final Class<T> clazz, final Integer code) {
    ...
    public static <T extends CodeEnum> boolean hasCode(final Class<T> clazz, final Integer code) {
        T[] values = clazz.getEnumConstants();
        for (T t : values) {
            if (t.getCode().equals(code)) {
                return true;
    ...
    public static <T extends CodeEnum> T fromCodeQuietly(final Class<T> clazz, final Integer code) {
        if (Objects.isNull(code)) {
            return null;
        }
    ...
    public static <T extends CodeEnum> boolean isCodeEnum(final Class<T> clazz, final Integer code) {
        if (code == null) {
            return false;
        }
    ...
    public static <T extends CodeEnum> boolean isValidEnum(final Class<T> clazz, final Integer code) {
        if (Objects.isNull(code)) {
            return true;
        }
    ...
    public static <T extends CodeEnum> List<T> valueList(final Class<T> clazz, final Integer[] codes) {
    ...
    public static <T extends CodeEnum> boolean equals(final T t, final Integer code) {
    ...
    public static <T extends CodeEnum> boolean contains(final List<T> list, final Integer code) {
